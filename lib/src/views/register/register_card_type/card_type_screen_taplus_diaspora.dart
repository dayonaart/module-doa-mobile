...
class CardTypeDiaspora extends StatefulWidget {
  const CardTypeDiaspora({Key? key}) : super(key: key);

  @override
  State<CardTypeDiaspora> createState() => _CardTypeDiasporaState();
}

class _CardTypeDiasporaState extends State<CardTypeDiaspora> {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        Get.off(() => TabunganLuarIndonesia(), transition: Transition.rightToLeft);
        return true;
      },
