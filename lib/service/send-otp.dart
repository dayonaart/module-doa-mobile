...
class SendOtpService {
  Future<SendOtpModel> sendOtp({
    ...
    var header = Get.find<DataController>().headerJson(step: 'Api Send Otp');
    ...
    if (response.statusCode == 200) {
      Get.find<OtpController>().state = Status.Success;
      var data = jsonDecode(response.body);
      Get.find<DataController>().prefs.setString('errorCode', data['errorCode']);
